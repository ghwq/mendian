...
var shopsList = [
  {
    ...
    location: [{
      latitude: 23.2092750000, 
      longitude: 113.2954860000,
      scale: 28,
      name: "仕馨月子会所（云山店）",
      address: "广州市白云区永平街丛云路382号（武警一中队旁）"}]
  },
  {
    title: "仕馨月子会所（越秀店）",
    ...
    img: ["../../img/report01.jpg", "../../img/report02.jpg", "../../img/report03.jpg"],
    location: [{
      latitude: 23.1243600000,
      longitude: 113.2545700000,
      scale: 28,
      name: "仕馨月子会所（越秀店）",
      address: "广州市越秀区人民中路408号大晟华厦（市妇婴医院旁)"
    }]
  },
  {
    title: "仕馨月子会所（西关店）",
